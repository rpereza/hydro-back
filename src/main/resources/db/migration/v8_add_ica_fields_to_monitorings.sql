-- Migration: Add ICA (Índice de Calidad del Agua) fields to monitorings table
-- Version: v8
-- Description: Adds three optional fields to monitorings table for ICA calculation:
...
-- Changes:
--   - Adds: number_ica_variables column to monitorings table
--   - Adds: ica_coefficient column to monitorings table
--   - Adds: quality_clasification column to monitorings table

-- =====================================================
-- 1. ADD number_ica_variables COLUMN
-- =====================================================

-- Add number_ica_variables column to monitorings table as nullable INTEGER
...
-- Add ica_coefficient column to monitorings table as nullable DECIMAL(3,2)
ALTER TABLE monitorings 
...
-- Add quality_clasification column to monitorings table as nullable VARCHAR
